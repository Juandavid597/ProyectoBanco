...
import com.example.demo.dto.TarjetaCredito;
...
public class TarjetaDeCreditoController {
    ...
    public ResponseEntity<?> listarClientes() {
        try {
            return ResponseHelper.response(HttpStatus.OK, true, fakeDb.getTarjetas(), "Este metodo debe listar todas las tarjetas de credito registradas en el banco");
        } catch (Exception e) {
    ...
    public ResponseEntity<?> ListarClientesId(@PathVariable String numeroTarjeta){
